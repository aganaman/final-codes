...
#    py ybo_local.py -p bios.raptorlake -s S -c bios -tp fv -f True -tpf C:\TOOLS\YBO_Portal\FV_TestPlan.xlsx -t 8
#    py ybo_local.py -p bios.raptorlake -P S -c bios -tp bat -f False -t 5
...
server_programs = ["bios.andersonlake", "bios.fishhawkfalls", "bios.eaglestream_sapphirerapids", "ifwi.eaglestream_sapphirerapids"]
...
#fv in client side bios and blue in server side bios
    ...
    test_coverage_levels_to_be_optimized = ["l3 extended-bat-fv", "l4 extended-fv"]
    logging.info("Test plan input - {0} found. Hence the test coverage levels to be optimized = {1}".format(args.tp.lower(), test_coverage_levels_to_be_optimized))
else:
...
def main():
    ...
    global args, mandatory_tcds, yielding_tcds, non_yielding_tcds, blocked_tcds, equivalent_programs, equivalent_programs_dictionary, \
           test_coverage_levels, test_coverage_levels_to_be_optimized, mandatory_test_coverage_levels, db_name, server_programs
    ...
    # For testing purpose
    # all_db_data = [('1508608189', '[PTT][PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1', 'L3 Extended-BAT-FV', '1508902421', '[PTT][PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1_bios.fishhawkfalls-Config 1', 'bios.alderlake', 'ANL_Orange', '1508902423', '[PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1_bios.fishhawkfalls-Config 1 [TC ID 1508902421]', 'blocked.blocked_due_to_open_sighting', 'bios.fishhawkfalls.Alpha.Server-BIOS.WW10_Blue_CLSV', '2021ww07.4', '', '', 'bios.platform', ''), 
    #                ('1508608189', '[PTT][PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1', 'L3 Extended-BAT-FV', '1508902421', '[PTT][PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1_bios.fishhawkfalls-Config 1', 'bios.alderlake', 'ANL_Orange', '1508904151', '[PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1_bios.fishhawkfalls-Config 1 [TC ID 1508902421]', 'open.not_run', 'bios.fishhawkfalls.Alpha.Server-BIOS.2021.09.2.02_WW10_Blue_CLSV', '2021ww02.5', '', '', '', ''), 
    #                ('1508608189', '[PTT][PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1', 'L3 Extended-BAT-FV', '1508902421', '[PTT][PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1_bios.fishhawkfalls-Config 1', 'bios.alderlake', 'ANL_Orange', '1508904625', '[PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1_bios.fishhawkfalls-Config 1 [TC ID 1508902421]', 'open.not_run', 'bios.fishhawkfalls.Alpha.Server-BIOS.2021.09.2.02_WW10_Blue_CLSV_2', '2021ww11.1', '', '', 'bios.cpu_pm', ''), 
    #                ('1508608189', '[PTT][PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1', 'L3 Extended-BAT-FV', '1508902421', '[PTT][PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1_bios.fishhawkfalls-Config 1', 'bios.alderlake', 'ANL_Orange', '1508904751', '[PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1_bios.fishhawkfalls-Config 1 [TC ID 1508902421]', 'blocked.blocked_due_to_open_sighting', 'bios.fishhawkfalls.Alpha.Server-BIOS.WW10_2021.09.2.02_Blue_CLSV', '2021ww17.4', '', '', '', ''), 
    #                ('1508608189', '[PTT][PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1', 'L3 Extended-BAT-FV', '1508902421', '[PTT][PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1_bios.fishhawkfalls-Config 1', 'bios.alderlake', 'ANL_Orange', '1509041821', '[PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1_bios.fishhawkfalls-Config 1 [TC ID 1508902421]', 'complete.fail', 'bios.fishhawkfalls.Alpha.Server-BIOS.WW14_Blue_2021.14.2.01_CLSV', '2021ww15.4', '', '', '', ''),
    #                ('1508608189', '[PTT][PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1', 'L3 Extended-BAT-FV', '1508902421', '[PTT][PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1_bios.fishhawkfalls-Config 1', 'bios.alderlake', 'ANL_Orange', '1509049999', '[PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1_bios.fishhawkfalls-Config 1 [TC ID 1508902421]', 'complete.fail', 'bios.fishhawkfalls.Alpha.Server-BIOS.WW14_Blue_2021.14.2.01_CLSV', '2021ww14.5', '', '', '', ''),
    #                ('1508608189', '[PTT][PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1', 'L3 Extended-BAT-FV', '1508902421', '[PTT][PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1_bios.fishhawkfalls-Config 1', 'bios.alderlake', 'ANL_Orange', '1509049998', '[PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1_bios.fishhawkfalls-Config 1 [TC ID 1508902421]', 'complete.fail', 'bios.fishhawkfalls.Alpha.Server-BIOS.WW14_Blue_2021.14.2.01_CLSV', '2021ww14.4', '', '', '', ''),
    #                ('1508608189', '[PTT][PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1', 'L3 Extended-BAT-FV', '1508902421', '[PTT][PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1_bios.fishhawkfalls-Config 1', 'bios.alderlake', 'ANL_Orange', '1509049997', '[PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1_bios.fishhawkfalls-Config 1 [TC ID 1508902421]', 'complete.fail', 'bios.fishhawkfalls.Alpha.Server-BIOS.WW14_Blue_2021.14.2.01_CLSV', '2021ww14.3', '', '', '', ''),
    #                ('1508608189', '[PTT][PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1', 'L3 Extended-BAT-FV', '1508902421', '[PTT][PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1_bios.fishhawkfalls-Config 1', 'bios.alderlake', 'ANL_Orange', '1509049996', '[PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1_bios.fishhawkfalls-Config 1 [TC ID 1508902421]', 'complete.fail', 'bios.fishhawkfalls.Alpha.Server-BIOS.WW14_Blue_2021.14.2.01_CLSV', '2021ww14.2', '', '', 'bios.iio', ''),
    #                ('1508608189', '[PTT][PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1', 'L3 Extended-BAT-FV', '1508902421', '[PTT][PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1_bios.fishhawkfalls-Config 1', 'bios.alderlake', 'ANL_Orange', '1509049995', '[PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1_bios.fishhawkfalls-Config 1 [TC ID 1508902421]', 'complete.fail', 'bios.fishhawkfalls.Alpha.Server-BIOS.WW14_Blue_2021.14.2.01_CLSV', '2021ww14.1', '', '', '', ''),
    #                ('1508608609', 'SMBI012 - Type 12 - System Configuration Options', 'L0 Check-in-CI', '1508777233', 'SMBI012 - Type 12 - System Configuration Options_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Blue,ANL_Orange', '1508777310', 'SMBI012 - Type 12 - System Configuration Options_bios.andersonlake-RVP [TC ID 1508777233]', 'open.not_run', 'bios.andersonlake.PV.Server-BIOS.', '2020ww07.2', '', '', '', ''),
    #                ('1508608609', 'SMBI012 - Type 12 - System Configuration Options', 'L0 Check-in-CI', '1508777233', 'SMBI012 - Type 12 - System Configuration Options_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Blue,ANL_Orange', '16012519601', 'SMBI012 - Type 12 - System Configuration Options_bios.andersonlake-RVP [TC ID 1508777233]', 'open.not_run', 'bios.andersonlake.PV.Server-BIOS.Chaitra_Blue', '2020ww07.2', '', '', 'bios.iio', ''),
    #                ('1508608609', 'SMBI012 - Type 12 - System Configuration Options', 'L0 Check-in-CI', '1508777233', 'SMBI012 - Type 12 - System Configuration Options_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Blue,ANL_Orange', '16012550162', 'SMBI012 - Type 12 - System Configuration Options_bios.andersonlake-RVP [TC ID 1508777233]', 'open.not_run', 'bios.andersonlake.PV.Server-BIOS.Blue_FSP_2107', '2020ww07.2', '', '', '', ''),
    #                ('1508608609', 'SMBI012 - Type 12 - System Configuration Options', 'L0 Check-in-CI', '1508777233', 'SMBI012 - Type 12 - System Configuration Options_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Blue,ANL_Orange', '16012709900', 'SMBI012 - Type 12 - System Configuration Options_bios.andersonlake-RVP [TC ID 1508777233]', 'open.not_run', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2109_Blue', '2020ww07.2', '', '', '', ''),
    #                ('1508608609', 'SMBI012 - Type 12 - System Configuration Options', 'L0 Check-in-CI', '1508777233', 'SMBI012 - Type 12 - System Configuration Options_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Blue,ANL_Orange', '16012709800', 'SMBI012 - Type 12 - System Configuration Options_bios.andersonlake-RVP [TC ID 1508777233]', 'open.not_run', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2108_Blue', '2020ww07.2', '', '', '', ''),
    #                ('1508608609', 'SMBI012 - Type 12 - System Configuration Options', 'L0 Check-in-CI', '1508777233', 'SMBI012 - Type 12 - System Configuration Options_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Blue,ANL_Orange', '16012709811', 'SMBI012 - Type 12 - System Configuration Options_bios.andersonlake-RVP [TC ID 1508777233]', 'open.not_run', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2108_Blue', '2020ww07.2', '', '', '', ''),
    #                ('1508608609', 'SMBI012 - Type 12 - System Configuration Options', 'L0 Check-in-CI', '1508777233', 'SMBI012 - Type 12 - System Configuration Options_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Blue,ANL_Orange', '16012709812', 'SMBI012 - Type 12 - System Configuration Options_bios.andersonlake-RVP [TC ID 1508777233]', 'open.not_run', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2108_Blue', '2020ww07.2', '', '', 'bios.iio', ''),
    #                ('1508608609', 'SMBI012 - Type 12 - System Configuration Options', 'L0 Check-in-CI', '1508777233', 'SMBI012 - Type 12 - System Configuration Options_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Blue,ANL_Orange', '16012709813', 'SMBI012 - Type 12 - System Configuration Options_bios.andersonlake-RVP [TC ID 1508777233]', 'open.not_run', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2108_Blue', '2020ww07.2', '', '', '', ''),
    #                ('1508608609', 'SMBI012 - Type 12 - System Configuration Options', 'L0 Check-in-CI', '1508777233', 'SMBI012 - Type 12 - System Configuration Options_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Blue,ANL_Orange', '16012709814', 'SMBI012 - Type 12 - System Configuration Options_bios.andersonlake-RVP [TC ID 1508777233]', 'open.not_run', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2108_Blue', '2020ww07.2', '', '', '', ''),
    #                ('1508608609', 'SMBI012 - Type 12 - System Configuration Options', 'L0 Check-in-CI', '1508777233', 'SMBI012 - Type 12 - System Configuration Options_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Blue,ANL_Orange', '16012709815', 'SMBI012 - Type 12 - System Configuration Options_bios.andersonlake-RVP [TC ID 1508777233]', 'open.not_run', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2108_Blue', '2020ww07.2', '', '', '', ''),
    #                ('1508607484', 'Trident Acres ping loss test', 'L2 Mandatory-BAT', '16012519451', 'Trident Acres ping loss test_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16012519477', 'Trident Acres ping loss test_bios.andersonlake-RVP [TC ID 16012519451]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.Chaitra_Blue', '2021ww12.2', '', '', '', ''),
    #                ('1508607484', 'Trident Acres ping loss test', 'L2 Mandatory-BAT', '16012519451', 'Trident Acres ping loss test_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16012550124', 'Trident Acres ping loss test_bios.andersonlake-RVP [TC ID 16012519451]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.Blue_FSP_2107', '2021ww12.5', '', '', '', ''),
    #                ('1508607484', 'Trident Acres ping loss test', 'L2 Mandatory-BAT', '16012519451', 'Trident Acres ping loss test_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16012709872', 'Trident Acres ping loss test_bios.andersonlake-RVP [TC ID 16012519451]', 'complete.fail', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2109_Blue', '2021ww10.4', '', '', '', ''),
    #                ('1508607484', 'Trident Acres ping loss test', 'L2 Mandatory-BAT', '16012519451', 'Trident Acres ping loss test_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16012917573', 'Trident Acres ping loss test_bios.andersonlake-RVP [TC ID 16012519451]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2113_Blue_chaitr1', '2021ww06.5', '', '', '', ''),
    #                ('1508607484', 'Trident Acres ping loss test', 'L2 Mandatory-BAT', '16012519451', 'Trident Acres ping loss test_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16012944996', 'Trident Acres ping loss test_bios.andersonlake-RVP [TC ID 16012519451]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.Blue_ANL_FSP_2119_chaitr2', '2021ww09.3', '', '', '', ''),
    #                ('1508607484', 'Trident Acres ping loss test', 'L2 Mandatory-BAT', '16012519451', 'Trident Acres ping loss test_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16013064154', 'Trident Acres ping loss test_bios.andersonlake-RVP [TC ID 16012519451]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.Blue_ANL_FSP_2119_chaitr3', '2021ww09.3', '', '', '', ''),
    #                ('1508607484', 'Trident Acres ping loss test', 'L2 Mandatory-BAT', '16012519451', 'Trident Acres ping loss test_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16013363789', 'Trident Acres ping loss test_bios.andersonlake-RVP [TC ID 16012519451]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.Blue_ANL_FSP_2119_chaitr4', '2021ww09.3', '', '', 'bios.cpu_pm', ''),
    #                ('1508607484', 'Trident Acres ping loss test', 'L2 Mandatory-BAT', '16012519451', 'Trident Acres ping loss test_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16013368992', 'Trident Acres ping loss test_bios.andersonlake-RVP [TC ID 16012519451]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.Blue_ANL_FSP_2119_chaitr5', '2021ww09.3', '', '', '', ''),
    #                ('1508607484', 'Trident Acres ping loss test', 'L2 Mandatory-BAT', '16012519451', 'Trident Acres ping loss test_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16012519999', 'Trident Acres ping loss test_bios.andersonlake-RVP [TC ID 16012519451]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.Blue_ANL_FSP_2119_chaitr6', '2021ww09.3', '', '', '', ''),
    #                ('1508607484', 'Trident Acres ping loss test', 'L2 Mandatory-BAT', '16012519451', 'Trident Acres ping loss test_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16012519998', 'Trident Acres ping loss test_bios.andersonlake-RVP [TC ID 16012519451]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.Blue_ANL_FSP_2119_chaitr7', '2021ww09.3', '', '', '', ''),
    #                ('1508607555', 'Cold Reset from UEFI Shell - 3 Cycles', 'L3 Extended-BAT-FV', '1508777498', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '1508777602', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP [TC ID 1508777498]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.', '2021ww17.4', '', '', '', ''),
    #                ('1508607555', 'Cold Reset from UEFI Shell - 3 Cycles', 'L3 Extended-BAT-FV', '1508777498', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16012519370', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP [TC ID 1508777498]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.Orange_FSP_2107', '2021ww11.1', '', '', '', ''),
    #                ('1508607555', 'Cold Reset from UEFI Shell - 3 Cycles', 'L3 Extended-BAT-FV', '1508777498', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16012549938', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP [TC ID 1508777498]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2109_Orange', '2020ww12.1', '', '', '', ''),
    #                ('1508607555', 'Cold Reset from UEFI Shell - 3 Cycles', 'L3 Extended-BAT-FV', '1508777498', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16012709668', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP [TC ID 1508777498]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.Orange_ANL_FSP_2119_chaitr1', '2021ww24.2', '', '', '', ''),
    #                ('1508607555', 'Cold Reset from UEFI Shell - 3 Cycles', 'L3 Extended-BAT-FV', '1508777498', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16013040020', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP [TC ID 1508777498]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2123_Orange_chaitr1', '2021ww09.5', '', '', '', ''),
    #                ('1508607555', 'Cold Reset from UEFI Shell - 3 Cycles', 'L3 Extended-BAT-FV', '1508777498', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16013049999', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP [TC ID 1508777498]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2123_Orange_chaitr2', '2021ww09.4', '', '', '', ''),
    #                ('1508607555', 'Cold Reset from UEFI Shell - 3 Cycles', 'L3 Extended-BAT-FV', '1508777498', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16013049998', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP [TC ID 1508777498]', 'complete.fail', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2123_Orange_chaitr3', '2021ww09.3', '', '', 'bios.platform', ''),
    #                ('1508607555', 'Cold Reset from UEFI Shell - 3 Cycles', 'L3 Extended-BAT-FV', '1508777498', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16013049997', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP [TC ID 1508777498]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2123_Orange_chaitr4', '2021ww09.2', '', '', 'bios.platform', ''),
    #                ('1508607555', 'Cold Reset from UEFI Shell - 3 Cycles', 'L3 Extended-BAT-FV', '1508777498', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16013049996', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP [TC ID 1508777498]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2123_Orange_chaitr5', '2021ww09.1', '', '', '', ''),
    #                ('1508607555', 'Cold Reset from UEFI Shell - 3 Cycles', 'L3 Extended-BAT-FV', '1508777498', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16013049995', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP [TC ID 1508777498]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2123_Orange_chaitr6', '2021ww03.5', '', '', '', ''),
    #                ('1508607555', 'Cold Reset from UEFI Shell - 3 Cycles', 'L3 Extended-BAT-FV', '1508777498', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP', 'bios.rocketlake', 'ANL_Orange', '16013049995', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP [TC ID 1508777498]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2123_Orange_chaitr6', '2021ww03.5', '', '', '', ''),
    #                ('1508607555', 'Cold Reset from UEFI Shell - 3 Cycles', 'L3 Extended-BAT-FV', '1508777498', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP', 'bios.rocketlake', 'ANL_Orange', '16013049995', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP [TC ID 1508777498]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2123_Orange_chaitr6', '2021ww14.5', '', '', '', ''),
    #                ('1508607555', 'Cold Reset from UEFI Shell - 3 Cycles', 'L3 Extended-BAT-FV', '1508777498', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP', 'bios.rocketlake', 'ANL_Orange', '16013049995', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP [TC ID 1508777498]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2123_Orange_chaitr6', '2021ww19.2', '', '', 'bios.platform', ''),
    #                ('1508607555', 'Cold Reset from UEFI Shell - 3 Cycles', 'L3 Extended-BAT-FV', '1508777498', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP', 'bios.rocketlake', 'ANL_Orange', '16013049995', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP [TC ID 1508777498]', 'complete.fail', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2123_Orange_chaitr6', '2021ww22.5', '', '', '', ''),
    #                ('1508607555', 'Cold Reset from UEFI Shell - 3 Cycles', 'L3 Extended-BAT-FV', '1508777498', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP', 'bios.rocketlake', 'ANL_Orange', '16013049995', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP [TC ID 1508777498]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2123_Orange_chaitr6', '2021ww19.3', '', '', '', ''),
    #                ('16012351903', '[Post-Si] To verify enumerated red core count', 'L4 Extended-FV', '1508777257', '[Post-Si] To verify enumerated red core count_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '1508777365', '[Post-Si] To verify enumerated red core count_bios.andersonlake-RVP [TC ID 1508777257]', 'open.not_run', 'bios.andersonlake.PV.Server-BIOS.', '', '', '', 'bios.iio', ''),
    #                ('16012351903', '[Post-Si] To verify enumerated red core count', 'L4 Extended-FV', '1508777257', '[Post-Si] To verify enumerated red core count_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '1508777365', '[Post-Si] To verify enumerated red core count_bios.andersonlake-RVP [TC ID 1508777257]', 'open.not_run', 'bios.andersonlake.PV.Server-BIOS.', '', '', '', '', ''),
    #                ('16012351903', '[Post-Si] To verify enumerated red core count', 'L4 Extended-FV', '1508777257', '[Post-Si] To verify enumerated red core count_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '1508777365', '[Post-Si] To verify enumerated red core count_bios.andersonlake-RVP [TC ID 1508777257]', 'open.not_run', 'bios.andersonlake.PV.Server-BIOS.', '', '', '', '', ''),
    #                ('16012351903', '[Post-Si] To verify enumerated red core count', 'L4 Extended-FV', '1508777257', '[Post-Si] To verify enumerated red core count_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '1508777365', '[Post-Si] To verify enumerated red core count_bios.andersonlake-RVP [TC ID 1508777257]', 'open.not_run', 'bios.andersonlake.PV.Server-BIOS.', '', '', '', '', ''),
    #                ('16012351903', '[Post-Si] To verify enumerated red core count', 'L4 Extended-FV', '1508777257', '[Post-Si] To verify enumerated red core count_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '1508777365', '[Post-Si] To verify enumerated red core count_bios.andersonlake-RVP [TC ID 1508777257]', 'open.not_run', 'bios.andersonlake.PV.Server-BIOS.', '', '', '', '', ''),
    #                ('16012351903', '[Post-Si] To verify enumerated red core count', 'L4 Extended-FV', '1508777257', '[Post-Si] To verify enumerated red core count_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '1508777365', '[Post-Si] To verify enumerated red core count_bios.andersonlake-RVP [TC ID 1508777257]', 'open.not_run', 'bios.andersonlake.PV.Server-BIOS.', '', '', '', '', ''),
    ...
    #                ('16012351903', '[Post-Si] To verify enumerated red core count', 'L4 Extended-FV', '1508777257', '[Post-Si] To verify enumerated red core count_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '1508777365', '[Post-Si] To verify enumerated red core count_bios.andersonlake-RVP [TC ID 1508777257]', 'open.not_run', 'bios.andersonlake.PV.Server-BIOS.', '', '', '', 'bios.iio', ''),
    #                ('16012351903', '[Post-Si] To verify enumerated red core count', 'L4 Extended-FV', '1508777257', '[Post-Si] To verify enumerated red core count_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '1508777365', '[Post-Si] To verify enumerated red core count_bios.andersonlake-RVP [TC ID 1508777257]', 'open.not_run', 'bios.andersonlake.PV.Server-BIOS.', '', '', '', '', ''),
    #                ('1508607679', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob', 'L3 Extended-BAT-FV', '1508777221', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '1508777253', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob_bios.andersonlake-RVP [TC ID 1508777221]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.', '2021ww18.5', '', '', '', ''),
    #                ('1508607679', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob', 'L3 Extended-BAT-FV', '1508777221', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16012519602', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob_bios.andersonlake-RVP [TC ID 1508777221]', 'complete.fail', 'bios.andersonlake.PV.Server-BIOS.Chaitra_Blue1', '', '', '', '', ''),
    #                ('1508607679', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob', 'L3 Extended-BAT-FV', '1508777221', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16012550138', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob_bios.andersonlake-RVP [TC ID 1508777221]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.Chaitra_Blue2', '', '', '', 'bios.iio', ''),
    #                ('1508607679', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob', 'L3 Extended-BAT-FV', '1508777221', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16012709888', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob_bios.andersonlake-RVP [TC ID 1508777221]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.Chaitra_Blue3', '', '', '', '', ''),
    #                ('1508607679', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob', 'L3 Extended-BAT-FV', '1508777221', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16019999887', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob_bios.andersonlake-RVP [TC ID 1508777221]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.Chaitra_Blue4', '2021ww17.2', '', '', '', ''),
    #                ('1508607679', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob', 'L3 Extended-BAT-FV', '1508777221', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16019993887', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob_bios.andersonlake-RVP [TC ID 1508777221]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.Chaitra_Blue5', '2021ww12.1', '', '', '', ''),
    #                ('1508607679', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob', 'L3 Extended-BAT-FV', '1508777221', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16019998887', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob_bios.andersonlake-RVP [TC ID 1508777221]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2113_Blue_chaitr1', '', '', '', 'bios.iio', ''),
    #                ('1508607679', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob', 'L3 Extended-BAT-FV', '1508777221', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16019997887', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob_bios.andersonlake-RVP [TC ID 1508777221]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2109_Blue1', '', '', '', '', ''),
    #                ('1508607679', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob', 'L3 Extended-BAT-FV', '1508777221', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16019996887', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob_bios.andersonlake-RVP [TC ID 1508777221]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2109_Blue2', '', '', '', '', ''),
    #                ('1508607679', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob', 'L3 Extended-BAT-FV', '1508777221', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16019995887', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob_bios.andersonlake-RVP [TC ID 1508777221]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2109_Blue3', '', '', '', '', ''),
    #                ('1508604836', '[Post-Si]To verify max green-AVX512 core configuration support', 'L3 Extended-BAT-FV', '1508777227', '[Post-Si]To verify max green-AVX512 core configuration support_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Blue', '16012519530', '[Post-Si]To verify max green-AVX512 core configuration support_bios.andersonlake-RVP [TC ID 1508777227]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.Chaitra_Blue', '', '', '', '', ''),
    #                ('1508604836', '[Post-Si]To verify max green-AVX512 core configuration support', 'L3 Extended-BAT-FV', '1508777227', '[Post-Si]To verify max green-AVX512 core configuration support_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Blue', '16012519530', '[Post-Si]To verify max green-AVX512 core configuration support_bios.andersonlake-RVP [TC ID 1508777227]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.Chaitra_Blue', '', '', '', '', ''),
    #                ('1508604836', '[Post-Si]To verify max green-AVX512 core configuration support', 'L3 Extended-BAT-FV', '1508777227', '[Post-Si]To verify max green-AVX512 core configuration support_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Blue', '16012519530', '[Post-Si]To verify max green-AVX512 core configuration support_bios.andersonlake-RVP [TC ID 1508777227]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.Chaitra_Blue', '', '', '', '', ''),
    #                ('1508604836', '[Post-Si]To verify max green-AVX512 core configuration support', 'L3 Extended-BAT-FV', '1508777227', '[Post-Si]To verify max green-AVX512 core configuration support_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Blue', '16012519530', '[Post-Si]To verify max green-AVX512 core configuration support_bios.andersonlake-RVP [TC ID 1508777227]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.Chaitra_Blue', '', '', '', 'bios.platform', ''),
    #                ('1508604836', '[Post-Si]To verify max green-AVX512 core configuration support', 'L3 Extended-BAT-FV', '1508777227', '[Post-Si]To verify max green-AVX512 core configuration support_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Blue', '16012519530', '[Post-Si]To verify max green-AVX512 core configuration support_bios.andersonlake-RVP [TC ID 1508777227]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.Chaitra_Blue', '', '', '', '', ''),
    #                ('1508604836', '[Post-Si]To verify max green-AVX512 core configuration support', 'L3 Extended-BAT-FV', '1508777227', '[Post-Si]To verify max green-AVX512 core configuration support_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Blue', '16012519530', '[Post-Si]To verify max green-AVX512 core configuration support_bios.andersonlake-RVP [TC ID 1508777227]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.Chaitra_Blue', '', '', '', '', ''),
    #                ('1508604836', '[Post-Si]To verify max green-AVX512 core configuration support', 'L3 Extended-BAT-FV', '1508777227', '[Post-Si]To verify max green-AVX512 core configuration support_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Blue', '16012519530', '[Post-Si]To verify max green-AVX512 core configuration support_bios.andersonlake-RVP [TC ID 1508777227]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.Chaitra_Blue', '', '', '', '', ''),
    #                ('1508604836', '[Post-Si]To verify max green-AVX512 core configuration support', 'L3 Extended-BAT-FV', '1508777227', '[Post-Si]To verify max green-AVX512 core configuration support_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Blue', '16012519530', '[Post-Si]To verify max green-AVX512 core configuration support_bios.andersonlake-RVP [TC ID 1508777227]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.Chaitra_Blue', '', '', '', '', ''),
    #                ('1508604836', '[Post-Si]To verify max green-AVX512 core configuration support', 'L3 Extended-BAT-FV', '1508777227', '[Post-Si]To verify max green-AVX512 core configuration support_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Blue', '16012519530', '[Post-Si]To verify max green-AVX512 core configuration support_bios.andersonlake-RVP [TC ID 1508777227]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.Chaitra_Blue', '', '', '', '', ''),
    #                ('1508604836', '[Post-Si]To verify max green-AVX512 core configuration support', 'L3 Extended-BAT-FV', '1508777227', '[Post-Si]To verify max green-AVX512 core configuration support_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Blue', '16012519530', '[Post-Si]To verify max green-AVX512 core configuration support_bios.andersonlake-RVP [TC ID 1508777227]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.Chaitra_Blue', '', '', '', 'bios.platform', ''),
    #                ('1508606695', 'SMBI017 - Type 20 Structure - Memory Device mapped address', 'L3 Extended-BAT-FV', '1508777289', 'SMBI017 - Type 20 Structure - Memory Device mapped address_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '1508777383', 'SMBI017 - Type 20 Structure - Memory Device mapped address_bios.andersonlake-RVP [TC ID 1508777289]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.Chaitra_Blue1', '2021ww09.2', '', '', '', ''),
    #                ('1508606695', 'SMBI017 - Type 20 Structure - Memory Device mapped address', 'L3 Extended-BAT-FV', '1508777289', 'SMBI017 - Type 20 Structure - Memory Device mapped address_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '1508191383', 'SMBI017 - Type 20 Structure - Memory Device mapped address_bios.andersonlake-RVP [TC ID 1508777289]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.Chaitra_Blue2', '2021ww09.2', '', '', '', ''),
    #                ('1508606695', 'SMBI017 - Type 20 Structure - Memory Device mapped address', 'L3 Extended-BAT-FV', '1508777289', 'SMBI017 - Type 20 Structure - Memory Device mapped address_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '1508197383', 'SMBI017 - Type 20 Structure - Memory Device mapped address_bios.andersonlake-RVP [TC ID 1508777289]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.Chaitra_Blue3', '2021ww09.2', '', '', '', ''),
    #                ('1111111111', 'Sample Test Case - Security', 'L3 Extended-BAT-FV', '1508777289', 'SMBI017 - Type 20 Structure - Memory Device mapped address_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '1508197383', 'SMBI017 - Type 20 Structure - Memory Device mapped address_bios.andersonlake-RVP [TC ID 1508777289]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.Chaitra_Blue3', '2021ww09.2', '', '', 'bios.security', ''),
    #                ('1111111111', 'Sample Test Case - Security', 'L3 Extended-BAT-FV', '1508777289', 'SMBI017 - Type 20 Structure - Memory Device mapped address_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '1508197383', 'SMBI017 - Type 20 Structure - Memory Device mapped address_bios.andersonlake-RVP [TC ID 1508777289]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.Chaitra_Blue3', '2021ww09.2', '', '', 'bios.security', ''),
    #                ('1111111111', 'Sample Test Case - Security', 'L3 Extended-BAT-FV', '1508777289', 'SMBI017 - Type 20 Structure - Memory Device mapped address_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '1508197383', 'SMBI017 - Type 20 Structure - Memory Device mapped address_bios.andersonlake-RVP [TC ID 1508777289]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.Chaitra_Blue3', '2021ww09.2', '', '', 'bios.security', ''),
    #                ('1111111111', 'Sample Test Case - Security', 'L3 Extended-BAT-FV', '1508777289', 'SMBI017 - Type 20 Structure - Memory Device mapped address_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '1508197383', 'SMBI017 - Type 20 Structure - Memory Device mapped address_bios.andersonlake-RVP [TC ID 1508777289]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.Chaitra_Blue3', '2021ww09.2', '', '', 'bios.security', ''),
    #                ('1111111111', 'Sample Test Case - Security', 'L3 Extended-BAT-FV', '1508777289', 'SMBI017 - Type 20 Structure - Memory Device mapped address_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '1508197383', 'SMBI017 - Type 20 Structure - Memory Device mapped address_bios.andersonlake-RVP [TC ID 1508777289]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.Chaitra_Blue3', '2021ww09.2', '', '', 'bios.security', ''),
    ...
    if manual_test_plan_file in [True, "True", "true"]:
        logging.info("Getting all data as per test plan file...")
        return_list = get_all_data_as_per_test_plan_file(test_plan_file, program_name, db_name, equivalent_programs, all_db_data, test_plan_name, charter)
        unique_tcd_ids = return_list[0]
        logging.info("Received unique_tcd_ids from test plan file = {0}".format(unique_tcd_ids))
        unique_tcd_data = return_list[1]
        mandatory_tcds.extend(return_list[3])
        logging.info("Received and updated mandatory_tcds from test plan file = {0}".format(mandatory_tcds))
        tp_data = return_list[4]
        logging.info("Getting all data as per test plan file done.")
    elif manual_test_plan_file in [False, "False", "false"]:
        ...
        # 1 - blocked (1508608189), 2 - mandatory (1508608609)
        # 3 - yield (1508607484), 4 - non-yield (1508607555)
        # 5 - L4 - not to be considered (16012351903), 6 - yield/non-yield - empty dates (1508607679)
        # For testing purpose
        # tp_data = [('1508608189', '[PTT][PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1', 'L3 Extended-BAT-FV', '1508902421', '[PTT][PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1_bios.fishhawkfalls-Config 1', 'bios.alderlake', 'ANL_Orange', '1508902423', '[PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1_bios.fishhawkfalls-Config 1 [TC ID 1508902421]', 'blocked.blocked_due_to_open_sighting', 'bios.fishhawkfalls.Alpha.Server-BIOS.WW10_Blue_CLSV', '2021ww07.4'), 
        #            ('1508608189', '[PTT][PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1', 'L3 Extended-BAT-FV', '1508902421', '[PTT][PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1_bios.fishhawkfalls-Config 1', 'bios.alderlake', 'ANL_Orange', '1508904151', '[PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1_bios.fishhawkfalls-Config 1 [TC ID 1508902421]', 'open.not_run', 'bios.fishhawkfalls.Alpha.Server-BIOS.2021.09.2.02_WW10_Blue_CLSV', '2021ww02.5'), 
        #            ('1508608189', '[PTT][PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1', 'L3 Extended-BAT-FV', '1508902421', '[PTT][PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1_bios.fishhawkfalls-Config 1', 'bios.alderlake', 'ANL_Orange', '1508904625', '[PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1_bios.fishhawkfalls-Config 1 [TC ID 1508902421]', 'open.not_run', 'bios.fishhawkfalls.Alpha.Server-BIOS.2021.09.2.02_WW10_Blue_CLSV_2', '2021ww11.1'), 
        #            ('1508608189', '[PTT][PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1', 'L3 Extended-BAT-FV', '1508902421', '[PTT][PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1_bios.fishhawkfalls-Config 1', 'bios.alderlake', 'ANL_Orange', '1508904751', '[PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1_bios.fishhawkfalls-Config 1 [TC ID 1508902421]', 'blocked.blocked_due_to_open_sighting', 'bios.fishhawkfalls.Alpha.Server-BIOS.WW10_2021.09.2.02_Blue_CLSV', '2021ww17.4'), 
        #            ('1508608189', '[PTT][PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1', 'L3 Extended-BAT-FV', '1508902421', '[PTT][PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1_bios.fishhawkfalls-Config 1', 'bios.alderlake', 'ANL_Orange', '1509041821', '[PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1_bios.fishhawkfalls-Config 1 [TC ID 1508902421]', 'complete.fail', 'bios.fishhawkfalls.Alpha.Server-BIOS.WW14_Blue_2021.14.2.01_CLSV', '2021ww15.4'),
        #            ('1508608189', '[PTT][PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1', 'L3 Extended-BAT-FV', '1508902421', '[PTT][PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1_bios.fishhawkfalls-Config 1', 'bios.alderlake', 'ANL_Orange', '1509049999', '[PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1_bios.fishhawkfalls-Config 1 [TC ID 1508902421]', 'complete.fail', 'bios.fishhawkfalls.Alpha.Server-BIOS.WW14_Blue_2021.14.2.01_CLSV', '2021ww14.5'),
        #            ('1508608189', '[PTT][PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1', 'L3 Extended-BAT-FV', '1508902421', '[PTT][PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1_bios.fishhawkfalls-Config 1', 'bios.alderlake', 'ANL_Orange', '1509049998', '[PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1_bios.fishhawkfalls-Config 1 [TC ID 1508902421]', 'complete.fail', 'bios.fishhawkfalls.Alpha.Server-BIOS.WW14_Blue_2021.14.2.01_CLSV', '2021ww14.4'),
        #            ('1508608189', '[PTT][PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1', 'L3 Extended-BAT-FV', '1508902421', '[PTT][PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1_bios.fishhawkfalls-Config 1', 'bios.alderlake', 'ANL_Orange', '1509049997', '[PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1_bios.fishhawkfalls-Config 1 [TC ID 1508902421]', 'complete.fail', 'bios.fishhawkfalls.Alpha.Server-BIOS.WW14_Blue_2021.14.2.01_CLSV', '2021ww14.3'),
        #            ('1508608189', '[PTT][PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1', 'L3 Extended-BAT-FV', '1508902421', '[PTT][PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1_bios.fishhawkfalls-Config 1', 'bios.alderlake', 'ANL_Orange', '1509049996', '[PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1_bios.fishhawkfalls-Config 1 [TC ID 1508902421]', 'complete.fail', 'bios.fishhawkfalls.Alpha.Server-BIOS.WW14_Blue_2021.14.2.01_CLSV', '2021ww14.2'),
        #            ('1508608189', '[PTT][PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1', 'L3 Extended-BAT-FV', '1508902421', '[PTT][PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1_bios.fishhawkfalls-Config 1', 'bios.alderlake', 'ANL_Orange', '1509049995', '[PostSi][Security][RPPC] TPM_PTT PCR value check - PCR07,PCR0 and PCR1_bios.fishhawkfalls-Config 1 [TC ID 1508902421]', 'complete.fail', 'bios.fishhawkfalls.Alpha.Server-BIOS.WW14_Blue_2021.14.2.01_CLSV', '2021ww14.1'),
        #            ('1508608609', 'SMBI012 - Type 12 - System Configuration Options', 'L0 Check-in-CI', '1508777233', 'SMBI012 - Type 12 - System Configuration Options_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Blue,ANL_Orange', '1508777310', 'SMBI012 - Type 12 - System Configuration Options_bios.andersonlake-RVP [TC ID 1508777233]', 'open.not_run', 'bios.andersonlake.PV.Server-BIOS.', '2020ww07.2'),
        #            ('1508608609', 'SMBI012 - Type 12 - System Configuration Options', 'L0 Check-in-CI', '1508777233', 'SMBI012 - Type 12 - System Configuration Options_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Blue,ANL_Orange', '16012519601', 'SMBI012 - Type 12 - System Configuration Options_bios.andersonlake-RVP [TC ID 1508777233]', 'open.not_run', 'bios.andersonlake.PV.Server-BIOS.Chaitra_Blue', '2020ww07.2'),
        #            ('1508608609', 'SMBI012 - Type 12 - System Configuration Options', 'L0 Check-in-CI', '1508777233', 'SMBI012 - Type 12 - System Configuration Options_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Blue,ANL_Orange', '16012550162', 'SMBI012 - Type 12 - System Configuration Options_bios.andersonlake-RVP [TC ID 1508777233]', 'open.not_run', 'bios.andersonlake.PV.Server-BIOS.Blue_FSP_2107', '2020ww07.2'),
        #            ('1508608609', 'SMBI012 - Type 12 - System Configuration Options', 'L0 Check-in-CI', '1508777233', 'SMBI012 - Type 12 - System Configuration Options_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Blue,ANL_Orange', '16012709900', 'SMBI012 - Type 12 - System Configuration Options_bios.andersonlake-RVP [TC ID 1508777233]', 'open.not_run', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2109_Blue', '2020ww07.2'),
        #            ('1508608609', 'SMBI012 - Type 12 - System Configuration Options', 'L0 Check-in-CI', '1508777233', 'SMBI012 - Type 12 - System Configuration Options_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Blue,ANL_Orange', '16012709800', 'SMBI012 - Type 12 - System Configuration Options_bios.andersonlake-RVP [TC ID 1508777233]', 'open.not_run', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2108_Blue', '2020ww07.2'),
        #            ('1508608609', 'SMBI012 - Type 12 - System Configuration Options', 'L0 Check-in-CI', '1508777233', 'SMBI012 - Type 12 - System Configuration Options_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Blue,ANL_Orange', '16012709811', 'SMBI012 - Type 12 - System Configuration Options_bios.andersonlake-RVP [TC ID 1508777233]', 'open.not_run', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2108_Blue', '2020ww07.2'),
        #            ('1508608609', 'SMBI012 - Type 12 - System Configuration Options', 'L0 Check-in-CI', '1508777233', 'SMBI012 - Type 12 - System Configuration Options_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Blue,ANL_Orange', '16012709812', 'SMBI012 - Type 12 - System Configuration Options_bios.andersonlake-RVP [TC ID 1508777233]', 'open.not_run', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2108_Blue', '2020ww07.2'),
        #            ('1508608609', 'SMBI012 - Type 12 - System Configuration Options', 'L0 Check-in-CI', '1508777233', 'SMBI012 - Type 12 - System Configuration Options_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Blue,ANL_Orange', '16012709813', 'SMBI012 - Type 12 - System Configuration Options_bios.andersonlake-RVP [TC ID 1508777233]', 'open.not_run', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2108_Blue', '2020ww07.2'),
        #            ('1508608609', 'SMBI012 - Type 12 - System Configuration Options', 'L0 Check-in-CI', '1508777233', 'SMBI012 - Type 12 - System Configuration Options_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Blue,ANL_Orange', '16012709814', 'SMBI012 - Type 12 - System Configuration Options_bios.andersonlake-RVP [TC ID 1508777233]', 'open.not_run', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2108_Blue', '2020ww07.2'),
        #            ('1508608609', 'SMBI012 - Type 12 - System Configuration Options', 'L0 Check-in-CI', '1508777233', 'SMBI012 - Type 12 - System Configuration Options_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Blue,ANL_Orange', '16012709815', 'SMBI012 - Type 12 - System Configuration Options_bios.andersonlake-RVP [TC ID 1508777233]', 'open.not_run', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2108_Blue', '2020ww07.2'),
        #            ('1508607484', 'Trident Acres ping loss test', 'L2 Mandatory-BAT', '16012519451', 'Trident Acres ping loss test_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16012519477', 'Trident Acres ping loss test_bios.andersonlake-RVP [TC ID 16012519451]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.Chaitra_Blue', '2021ww12.2'),
        ...
        #            ('1508607484', 'Trident Acres ping loss test', 'L2 Mandatory-BAT', '16012519451', 'Trident Acres ping loss test_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16012944996', 'Trident Acres ping loss test_bios.andersonlake-RVP [TC ID 16012519451]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.Blue_ANL_FSP_2119_chaitr2', '2021ww09.3'),
        #            ('1508607484', 'Trident Acres ping loss test', 'L2 Mandatory-BAT', '16012519451', 'Trident Acres ping loss test_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16013064154', 'Trident Acres ping loss test_bios.andersonlake-RVP [TC ID 16012519451]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.Blue_ANL_FSP_2119_chaitr3', '2021ww09.3'),
        #            ('1508607484', 'Trident Acres ping loss test', 'L2 Mandatory-BAT', '16012519451', 'Trident Acres ping loss test_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16013363789', 'Trident Acres ping loss test_bios.andersonlake-RVP [TC ID 16012519451]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.Blue_ANL_FSP_2119_chaitr4', '2021ww09.3'),
        #            ('1508607484', 'Trident Acres ping loss test', 'L2 Mandatory-BAT', '16012519451', 'Trident Acres ping loss test_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16013368992', 'Trident Acres ping loss test_bios.andersonlake-RVP [TC ID 16012519451]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.Blue_ANL_FSP_2119_chaitr5', '2021ww09.3'),
        #            ('1508607484', 'Trident Acres ping loss test', 'L2 Mandatory-BAT', '16012519451', 'Trident Acres ping loss test_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16012519999', 'Trident Acres ping loss test_bios.andersonlake-RVP [TC ID 16012519451]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.Blue_ANL_FSP_2119_chaitr6', '2021ww09.3'),
        #            ('1508607484', 'Trident Acres ping loss test', 'L2 Mandatory-BAT', '16012519451', 'Trident Acres ping loss test_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16012519998', 'Trident Acres ping loss test_bios.andersonlake-RVP [TC ID 16012519451]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.Blue_ANL_FSP_2119_chaitr7', '2021ww09.3'),
        #            ('1508607555', 'Cold Reset from UEFI Shell - 3 Cycles', 'L3 Extended-BAT-FV', '1508777498', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '1508777602', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP [TC ID 1508777498]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.', '2021ww17.4'),
        ...
        #            ('1508607555', 'Cold Reset from UEFI Shell - 3 Cycles', 'L3 Extended-BAT-FV', '1508777498', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16013040020', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP [TC ID 1508777498]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2123_Orange_chaitr1', '2021ww09.5'),
        #            ('1508607555', 'Cold Reset from UEFI Shell - 3 Cycles', 'L3 Extended-BAT-FV', '1508777498', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16013049999', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP [TC ID 1508777498]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2123_Orange_chaitr2', '2021ww09.4'),
        #            ('1508607555', 'Cold Reset from UEFI Shell - 3 Cycles', 'L3 Extended-BAT-FV', '1508777498', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16013049998', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP [TC ID 1508777498]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2123_Orange_chaitr3', '2021ww09.3'),
        #            ('1508607555', 'Cold Reset from UEFI Shell - 3 Cycles', 'L3 Extended-BAT-FV', '1508777498', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16013049997', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP [TC ID 1508777498]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2123_Orange_chaitr4', '2021ww09.2'),
        #            ('1508607555', 'Cold Reset from UEFI Shell - 3 Cycles', 'L3 Extended-BAT-FV', '1508777498', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16013049996', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP [TC ID 1508777498]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2123_Orange_chaitr5', '2021ww09.1'),
        #            ('1508607555', 'Cold Reset from UEFI Shell - 3 Cycles', 'L3 Extended-BAT-FV', '1508777498', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16013049995', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP [TC ID 1508777498]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2123_Orange_chaitr6', '2021ww03.5'),
        #            ('1508607555', 'Cold Reset from UEFI Shell - 3 Cycles', 'L3 Extended-BAT-FV', '1508777498', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP', 'bios.rocketlake', 'ANL_Orange', '16013049995', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP [TC ID 1508777498]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2123_Orange_chaitr6', '2021ww03.5'),
        #            ('1508607555', 'Cold Reset from UEFI Shell - 3 Cycles', 'L3 Extended-BAT-FV', '1508777498', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP', 'bios.rocketlake', 'ANL_Orange', '16013049995', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP [TC ID 1508777498]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2123_Orange_chaitr6', '2021ww14.5'),
        #            ('1508607555', 'Cold Reset from UEFI Shell - 3 Cycles', 'L3 Extended-BAT-FV', '1508777498', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP', 'bios.rocketlake', 'ANL_Orange', '16013049995', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP [TC ID 1508777498]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2123_Orange_chaitr6', '2021ww19.2'),
        #            ('1508607555', 'Cold Reset from UEFI Shell - 3 Cycles', 'L3 Extended-BAT-FV', '1508777498', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP', 'bios.rocketlake', 'ANL_Orange', '16013049995', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP [TC ID 1508777498]', 'complete.fail', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2123_Orange_chaitr6', '2021ww02.5'),
        #            ('1508607555', 'Cold Reset from UEFI Shell - 3 Cycles', 'L3 Extended-BAT-FV', '1508777498', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP', 'bios.rocketlake', 'ANL_Orange', '16013049995', 'Cold Reset from UEFI Shell - 3 Cycles_bios.andersonlake-RVP [TC ID 1508777498]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2123_Orange_chaitr6', '2021ww19.3'),
        #            ('16012351903', '[Post-Si] To verify enumerated red core count', 'L4 Extended-FV', '1508777257', '[Post-Si] To verify enumerated red core count_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '1508777365', '[Post-Si] To verify enumerated red core count_bios.andersonlake-RVP [TC ID 1508777257]', 'open.not_run', 'bios.andersonlake.PV.Server-BIOS.', ''),
        #            ('16012351903', '[Post-Si] To verify enumerated red core count', 'L4 Extended-FV', '1508777257', '[Post-Si] To verify enumerated red core count_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '1508777365', '[Post-Si] To verify enumerated red core count_bios.andersonlake-RVP [TC ID 1508777257]', 'open.not_run', 'bios.andersonlake.PV.Server-BIOS.', ''),
        #            ('16012351903', '[Post-Si] To verify enumerated red core count', 'L4 Extended-FV', '1508777257', '[Post-Si] To verify enumerated red core count_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '1508777365', '[Post-Si] To verify enumerated red core count_bios.andersonlake-RVP [TC ID 1508777257]', 'open.not_run', 'bios.andersonlake.PV.Server-BIOS.', ''),
        ...
        #            ('1508607679', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob', 'L3 Extended-BAT-FV', '1508777221', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '1508777253', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob_bios.andersonlake-RVP [TC ID 1508777221]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.', '2021ww18.5'),
        #            ('1508607679', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob', 'L3 Extended-BAT-FV', '1508777221', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16012519602', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob_bios.andersonlake-RVP [TC ID 1508777221]', 'complete.fail', 'bios.andersonlake.PV.Server-BIOS.Chaitra_Blue1', ''),
        #            ('1508607679', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob', 'L3 Extended-BAT-FV', '1508777221', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16012550138', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob_bios.andersonlake-RVP [TC ID 1508777221]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.Chaitra_Blue2', ''),
        #            ('1508607679', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob', 'L3 Extended-BAT-FV', '1508777221', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16012709888', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob_bios.andersonlake-RVP [TC ID 1508777221]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.Chaitra_Blue3', ''),
        #            ('1508607679', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob', 'L3 Extended-BAT-FV', '1508777221', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16019999887', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob_bios.andersonlake-RVP [TC ID 1508777221]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.Chaitra_Blue4', '2021ww17.2'),
        #            ('1508607679', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob', 'L3 Extended-BAT-FV', '1508777221', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16019993887', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob_bios.andersonlake-RVP [TC ID 1508777221]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.Chaitra_Blue5', '2021ww12.1'),
        #            ('1508607679', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob', 'L3 Extended-BAT-FV', '1508777221', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16019998887', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob_bios.andersonlake-RVP [TC ID 1508777221]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2113_Blue_chaitr1', ''),
        #            ('1508607679', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob', 'L3 Extended-BAT-FV', '1508777221', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16019997887', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob_bios.andersonlake-RVP [TC ID 1508777221]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2109_Blue1', ''),
        #            ('1508607679', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob', 'L3 Extended-BAT-FV', '1508777221', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16019996887', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob_bios.andersonlake-RVP [TC ID 1508777221]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2109_Blue2', ''),
        #            ('1508607679', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob', 'L3 Extended-BAT-FV', '1508777221', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '16019995887', '[Post-Si] PPV request - Rename DfxAltPostCode as PPV Knob control - Rank Margin Knob_bios.andersonlake-RVP [TC ID 1508777221]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.ANL_FSP_2109_Blue3', ''),
        #            ('1508606695', 'SMBI017 - Type 20 Structure - Memory Device mapped address', 'L3 Extended-BAT-FV', '1508777289', 'SMBI017 - Type 20 Structure - Memory Device mapped address_bios.andersonlake-RVP', 'bios.alderlake', 'ANL_Orange', '1508777383', 'SMBI017 - Type 20 Structure - Memory Device mapped address_bios.andersonlake-RVP [TC ID 1508777289]', 'complete.pass', 'bios.andersonlake.PV.Server-BIOS.Chaitra_Blue1', '2021ww09.2'),
    ...
    for unq_tcd_id in unique_tcd_ids:
        ...
        # for d in all_data_buckets:
            if str(d[0]) == str(unq_tcd_id):
                ...
                if d[2].lower() in mandatory_test_coverage_levels:
    ...
    for unq_tcd_id in unique_tcd_ids:
        ...
        # for d in all_data_buckets:
            if str(d[0]) == str(unq_tcd_id):
                if d[2].lower() not in test_coverage_levels_to_be_optimized:
    ...
    sorted_all_data_buckets = sort_test_results_by_actual_end_date(all_data_buckets)
...
def get_all_data_as_per_test_plan_file(test_plan_file, program_name, db_name, equivalent_programs, all_db_data, test_plan_name, charter):
    
    test_plan_file_unique_tcds = []
    test_plan_file_unique_tcd_data_dictionary = {}
    test_plan_file_unique_tcd_data = []
    test_plan_mandatory_tcd_data = []
    test_plan_mandatory_tcd_ids = []
    test_plan_all_db_data = []
    # test_plan_file = r'C:\Users\hdave\Documents\YBO_Portal\test_plan.csv'
    ...
    logging.info(f"Before applying filter, test_plan_file_unique_tcds = {test_plan_file_unique_tcds}")
    temp_unq_tcds = []
    temp_unique_tcd_data = {}
    for tp_file_tcd in test_plan_file_unique_tcds:
        print("\n{0} - Started".format(tp_file_tcd))
        flag = False
        for tp_file_row in all_db_data:
            if tp_file_tcd == tp_file_row[0]:
                print("\n{0} - found in All DB Data... Hence flag=True")
                flag = True
                if tp_file_tcd not in temp_unq_tcds:
                    print("\n{0} - Going to unique TCD list.".format(tp_file_tcd))
                    temp_unq_tcds.append(tp_file_tcd)
                    temp_unique_tcd_data[tp_file_tcd] = test_plan_file_unique_tcd_data_dictionary[tp_file_tcd]
            else:
                print("\n{0} - Not equal... Comparison failed: {0} and {1}".format(tp_file_tcd, tp_file_row[0]))
        if not flag:
            print("\n{0} - Flag did not set... going into mandatory list.")
            if tp_file_tcd not in test_plan_mandatory_tcd_ids:
                test_plan_mandatory_tcd_ids.append(tp_file_tcd)
                test_plan_mandatory_tcd_data.append([tp_file_tcd, test_plan_file_unique_tcd_data_dictionary[tp_file_tcd]])

    test_plan_file_unique_tcds = temp_unq_tcds
    test_plan_file_unique_tcd_data_dictionary = temp_unique_tcd_data

    logging.info(f"After applying filter, test_plan_file_unique_tcds = {test_plan_file_unique_tcds}")
    logging.info(f"After applying filter, test_plan_mandatory_tcd_ids = {test_plan_mandatory_tcd_ids}")


    logging.info(f"Before applying test plan filter, test_plan_file_unique_tcds = {test_plan_file_unique_tcds}")
    temp_unq_tcds = []
    temp_unique_tcd_data = {}
    for tp_file_tcd in test_plan_file_unique_tcds:
        for tp_file_row in all_db_data:
            if tp_file_tcd == tp_file_row[0]:
                if test_plan_name in tp_file_row[6].lower():
                    if tp_file_tcd not in temp_unq_tcds:
                        temp_unq_tcds.append(tp_file_tcd)
                        temp_unique_tcd_data[tp_file_tcd] = test_plan_file_unique_tcd_data_dictionary[tp_file_tcd]
                else:
                    logging.info("Test plan name {0} not matching with {1} for {2}".format(test_plan_name, tp_file_row[6].lower(), tp_file_tcd))

    test_plan_file_unique_tcds = temp_unq_tcds
    test_plan_file_unique_tcd_data_dictionary = temp_unique_tcd_data

    logging.info(f"After applying test plan filter, test_plan_file_unique_tcds = {test_plan_file_unique_tcds}")
    logging.info(f"After applying test plan filter, test_plan_mandatory_tcd_ids = {test_plan_mandatory_tcd_ids}")

    for tp_file_tcd in test_plan_file_unique_tcds:
        for tp_file_row in all_db_data:
            if tp_file_tcd == tp_file_row[0]:
                test_plan_all_db_data.append(tp_file_row)
    for k, v in test_plan_file_unique_tcd_data_dictionary.items():
        test_plan_file_unique_tcd_data.append([k, v])
    # print("test_plan_file_unique_tcds = {0}".format(test_plan_file_unique_tcds))
    # print("test_plan_file_unique_tcd_data_dictionary = {0}".format(test_plan_file_unique_tcd_data_dictionary))
    # print("test_plan_file_unique_tcd_data = {0}".format(test_plan_file_unique_tcd_data))
    # print("test_plan_mandatory_tcd_data = {0}".format(test_plan_mandatory_tcd_data))
    # print("test_plan_all_db_data = {0}".format(test_plan_all_db_data))

    return [test_plan_file_unique_tcds, test_plan_file_unique_tcd_data, test_plan_file_unique_tcd_data_dictionary, test_plan_mandatory_tcd_data, test_plan_all_db_data]
...
def sort_test_results_by_actual_end_date(all_data_buckets):
                ...
                if str(row[0][0]) == str(unq_tcd_id):
                    ...
                    if eq_program:
                        for row_record in row:
                            if row_record[5] in equivalent_programs:
                                eq_program_tr_counter[equivalent_programs.index(row_record[5])] += 1
                            elif row_record[5] == program_name:
                    ...
                    if current_program_tr_counter >= threshold:
                        ...
                        for run in range(len(row)):
                            if counter1 <= int(threshold/2):
                                if row[run][5] == program_name:
                                    counter1 += 1
                        ...
                        if failure_counter_current_program > 0:
                            ...
                            if eq_program:
                                ...
                                counter2 = 0
                                for run in range(len(row)):
                                    if counter2 <= int(threshold/2):
                                        if row[run][5] in equivalent_programs:
                                            counter2 += 1
                                            if "fail" in row[run][9]:
                                                if [str(unq_tcd_id), row[0][1]] not in failed_tcd_data_legacy:
                                                    ...
                                                    failure_counter_legacy_program[equivalent_programs.index(row[run][5])] += 1
                                                    break
                                    else:
                                        break
                                ...
                                if any(fd > 0 for fd in failure_counter_legacy_program):
                                    ...
                                    if (program_name in c1s) and (row[run][5] in c1s):
