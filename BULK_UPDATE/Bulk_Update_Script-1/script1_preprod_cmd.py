...
if __name__ == "__main__":
    ...
    #py script1_preprod_cmd.py -p C:\NAMAN\Share\Bulk_Update_Script-1\Book5.csv -tc "bios.a21.A0 PO Exit.Client-BIOS.bob_test" -sv "complete" -rv "fail" -rl "bios.alderlake" -lt "parent-child" -o "namanaga" 
    #py script1_preprod_cmd.py -p C:\NAMAN\Share\Bulk_Update_Script-1\Book5.csv -tc "bios.a21.A0 PO Exit.Client-BIOS.bob_test" -sv "blocked" -rv "other" -rl "bios.alderlake" -lt "parent-child" -o "namanaga" -ro "manual_result"